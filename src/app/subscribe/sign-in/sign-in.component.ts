...
export class SignInComponent implements OnInit {
  ...
  constructor(public authService: AuthService, private auth0Service: Auth0Service, private router: Router, iconRegistry: MatIconRegistry, sanitizer: DomSanitizer) {
